...
const TabButton = ({ active, icon: Icon, label, onClick }) => (
    ...
    >
        ...
        {active && (
            <motion.div
                layoutId="activeTab"
                className="absolute bottom-0 left-0 right-0 h-0.5 bg-matisse-500 shadow-[0_0_10px_rgba(59,130,246,0.5)]"
            />
        )}
    </button>
);
            ...
            <div className="flex justify-between items-end">
                ...
                <button
                    ...
                    className={`flex items-center gap-2 px-6 py-2.5 rounded-xl font-bold transition-all ${saved
                            ? "bg-matisse-500 text-white"
                            : "bg-matisse-600 hover:bg-matisse-700 text-white shadow-lg shadow-blue-900/20"
                        } disabled:opacity-50`}
                >
                    {saving ? (
                        <motion.div
                    ...
                    <AnimatePresence mode="wait">
                        ...
                        {activeTab === "security" && (
                            ...
                            >
                                ...
                                >
                                    <button className="bg-matisse-600/10 text-matisse-400 hover:bg-matisse-600/20 px-4 py-2 rounded-lg text-sm font-bold transition-all">Enable 2FA</button>
                                </SettingRow>
                                <SettingRow
                                    label="Password Requirements"
                                    description="Enforce strong passwords for all team members."
                                >
                                    <div className="flex items-center gap-2 text-matisse-400 text-sm font-bold">
                        ...
                        {activeTab === "notifications" && (
                            ...
                            >
                                <SettingRow label="Email Notifications" description="Receive updates and alerts via email.">
                                    <div className="w-12 h-6 bg-matisse-600 rounded-full relative cursor-pointer shadow-inner">
                                ...
                                <SettingRow label="Payment Success" description="Notify when a client completes a payment.">
                                    <div className="w-12 h-6 bg-matisse-600 rounded-full relative cursor-pointer">
                                        <div className="absolute right-1 top-1 w-4 h-4 bg-white rounded-full" />
                                    </div>
                                </SettingRow>
