    ...
    <section ref={containerRef} className="relative min-h-screen flex flex-col items-center justify-center pt-40 pb-32 px-6 z-10 overflow-visible">
      <div className="max-w-7xl mx-auto text-center mb-20 relative z-10">
        <motion.div
          ...
          className="inline-flex items-center gap-2 px-4 py-1 rounded-full bg-calypso-500/10 dark:bg-calypso-300/5 text-calypso-700 dark:text-calypso-300 text-[10px] font-semibold mb-12 tracking-[0.3em] uppercase backdrop-blur-sm border border-calypso-500/10 dark:border-calypso-300/10"
        >
        ...
        <div ref={buttonsRef} className="flex flex-col sm:flex-row items-center justify-center gap-8">
          <button className="px-12 py-6 bg-slate-950 dark:bg-calypso-500 dark:text-white text-white font-semibold rounded-3xl transition-all hover:scale-[1.03] active:scale-95 shadow-[0_30px_60px_rgba(0,0,0,0.1)] text-lg">
            Start Recovery
          </button>

          <button className="px-12 py-6 bg-white dark:bg-transparent text-slate-900 dark:text-calypso-300 font-semibold rounded-3xl border border-slate-200 dark:border-calypso-800/30 transition-all hover:bg-slate-50 dark:hover:bg-calypso-900/20 backdrop-blur-xl text-lg flex items-center gap-3 group">
