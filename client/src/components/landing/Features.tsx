      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {features.map((f, i) => (
            ...
            >
              <div className="absolute inset-0 bg-gradient-to-br from-blue-500/0 via-transparent to-blue-500/0 group-hover:from-blue-500/[0.05] group-hover:to-indigo-500/[0.05] transition-all duration-700 rounded-[2.5rem]" />
              
              <div className="relative z-10">
                <div className="w-14 h-14 rounded-2xl bg-white/[0.03] border border-white/10 flex items-center justify-center mb-8 group-hover:scale-110 group-hover:bg-[#00ff7f]/10 group-hover:border-blue-500/20 transition-all duration-500">
                  {f.icon}
                </div>
                <h3 className="text-2xl font-semibold text-white mb-4 tracking-tight group-hover:text-blue-400 transition-colors">
                  {f.title}
                </h3>
